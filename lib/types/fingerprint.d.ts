 ...
 */
export declare function symbolPathOf(file: string, symbol?: string, member?: string): string;
/**
 ...
 * @returns 16 位十六进制摘要。
 */
export declare function featureDigestOf(feature: string | undefined, fallback: string): string;
/**
 * 由三元组计算指纹。
 * @param parts - 规则、符号路径、特征摘要。
 * @returns 16 位十六进制指纹。
 */
export declare function fingerprintOf(parts: FingerprintParts): string;
/**
 ...
 * @returns 是否视为同一问题。
 */
export declare function isSameFinding(left: FingerprintParts, right: FingerprintParts): boolean;
